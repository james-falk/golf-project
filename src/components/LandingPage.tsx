        ...
        <div className="bg-white rounded-xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-center text-lg font-mono tracking-widest uppercase"
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg">
            ...
            <ul className="text-xs text-gray-600 space-y-1">
              <li>• <strong>Admin Code:</strong> Full access to enter and edit scores</li>
              <li>• <strong>Viewer Code:</strong> Read-only access to view results</li>
            </ul>
          </div>
        </div>
      </div>
